"""
Django settings for Empire_electronics project.
...
SECRET_KEY = 'django-insecure-8!bvlym1vy_!#%ixq(p21_y88wgfcwq6j+k9wgp7*z(5^g+++x'
...
ROOT_URLCONF = 'Empire_electronics.urls'
